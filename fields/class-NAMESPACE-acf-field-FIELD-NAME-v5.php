...
class NAMESPACE_acf_field_FIELD_NAME extends acf_field {
	...
	*/
	...
	function load_value( $value, $post_id, $field ) {
		...
		$video = $r;
		// $placeholderImageID = $params['video']['placeholder_image'];
		// $placeholderImageURL = wp_get_attachment_image_url($placeholderImageID, 'full', false);
		?>
					...
					<div class="col-12">
						<div class="single-video-container">
							<?php if($video['video'] == 'vimeo') { ?>
								<iframe src="https://player.vimeo.com/video/<?= $video['id']?>?h=e56f6d099b&title=0&byline=0&portrait=0" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
							<?php } else { ?>
								<iframe id="singleVideo" width="560" height="315" src="https://www.youtube.com/embed/<?= $video['id']?>?enablejsapi=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<?php } ?>

							<img class="single-video-thumbnail" src="<?php //echo $placeholderImageURL ?>" alt="">
							<div class="overlay"></div>
							<button id="play-btn-wrap" type="button" class="btn-video p-0">
								<div id="play-btn" class="play-btn">
									<img id="play" src="<?php echo get_template_directory_uri() ?>/assets/img/svg/play-btn.svg" alt="play button">
								</div> 
								<div id="pause-btn" class="pause-btn d-none">
									<img id="pause" src="<?php echo get_template_directory_uri() ?>/assets/img/svg/pause-btn.svg" alt="play button">
								</div> 
							</button>
						</div>
					</div>
